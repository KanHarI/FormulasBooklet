...
\node [mybox] (box){%
    \begin{minipage}{0.46\textwidth}
        ...
        Full derivation of the cubic formula is provided as using it in tests without derivation been known to lead to score detraction. For cubic equations of the form $x^3 + bx^2 + cx + d = 0$, do a variable substitution to transform the equation into a depressed cubic w.r.t. $t$:
...
\node [mybox] (box){%
    \begin{minipage}{0.46\textwidth}
        ...
        t^4 - at^3 + \frac{3a^2t^2}{8} - \frac{a^3t}{16} + \frac{a^4}{256} + a\left(t^3 - \frac{3at^2}{4} + \frac{3a^2t}{16} - \frac{a^3}{64} \right) + b \left(t^2 - \frac{at}{2} + \frac{a^2}{16} \right)
         ...
         There are 2 resulting quadratic equations requlting for this. Solve them to find the 4 solutions for the original quartic in terms of $t$, $t_1, t_2, t_3, t_4$.
         $$ x = t - \frac{a}{4} $$
         $$ x_1 = t_1 - \frac{a}{4}, x_2 = t_2 - \frac{a}{4}, x_3 = t_3 - \frac{a}{4}, x_4 = t_4 - \frac{a}{4} $$
         }
        If you have followed this derivation and solved an equation, give yourself +5 pts for determination. \\
